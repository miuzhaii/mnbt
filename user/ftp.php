...
<script type="text/javascript">
    ...
    $('#tb_departments').on('uncheck.bs.table check.bs.table check-all.bs.table uncheck-all.bs.table load-success.bs.table', function () {        //监听选中与取消选中
        var xzh=hqxzh(false);
        var hasSelection = xzh!==false;
        if(hasSelection === multiActionVisible){
            return;
        }
        multiActionVisible = hasSelection;
        if(hasSelection){     //有选中行
