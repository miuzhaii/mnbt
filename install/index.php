...
function mnqz() {
  ...
  return array('code'=>1,'authcode'=>'您安装时使用的为离线安装！');
  }
}
...
<center><div class="alert alert-success"><a href="https://ww1.im/94p6"><img class="img-circle m-b-xs" style="border: 2px solid #1281FF; margin-left:3px; margin-right:3px;" src="https://q4.qlogo.cn/headimg_dl?dst_uin=3108807898&spec=100"; width="60px" height="60px" alt="<?php echo $conf['sitename']; ?>"><br></a>欢迎使用由梦奈基于光年V3框架原创的MN宝塔主机系统(简称MNBT)！本系统免费发布于网络！</br>官网：<a href="http://mf.mengnai.top/" target="_blank">mf.mengnai.top</a><br>未经作者同意严禁任何形式的二次开发及引用！<br><small>2023by:梦奈</br>系统版本：V1.6</small>
</div></center>
		<?php if($installed){ ?>
		<div class="alert alert-warning">您已经安装过，如需重新安装请<font color=red>从官网重新下载源码</font>文件后再安装！</div>
		<?php }else{?>
		<input type="checkbox" name="gxk" id="eei" value="Car" onclick="eey()"/>勾选则代表您同意遵守<a href='../xy.html' target="_blank"/>MN系统使用协议</a>
		<p align="center"><a class="btn btn-primary" id="abq" style="opacity: 0.2" href="javascript:return false;">开始安装</a></p>
...
<table class="table table-striped">
	...
	<tbody>
		<tr>
			<td>PHP 7.4 ~ 7.6</td>
			<td>必须</td>
			<td><?php $php_vs=version_compare(PHP_VERSION, '7.4.0', '>') && version_compare(PHP_VERSION, '7.7.0', '<'); echo $php_vs ?'<font color="green" id="server-code">'.PHP_VERSION.'</font>':'<font color="red" id="server-code">'.PHP_VERSION.'</font>'; ?></td>
			<td>PHP版本支持</td>
		</tr>
		<tr>
			<td>curl_exec()</td>
...
<span style="float:right"><a class="btn btn-primary" id="next" href="index.php?do=2" align="right">下一步>></a></span></p>
</div>
<script>
